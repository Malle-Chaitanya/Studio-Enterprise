...
const AGENT_ID = '11078644586713090223'; // new WorkMate
...
async function main() {
  ...
  writeFileSync('C:/Users/CHAITA~1/AppData/Local/Temp/claude/C--Users-ChaitanyaMalle-Studio-Enterprise-Studio-Enterprise/33f35a95-8f9f-4dcf-ab87-9f2d26f4aa42/scratchpad/hubspot_test2.json', text);
  const hasCall = /functionCall|functionResponse/.test(text);
  console.log('Has real tool call frames:', hasCall);
